          ...
          <div className="p-6 border-b border-zinc-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <button
                ...
                className="px-4 py-4 bg-zinc-800 border border-amber-500/30 text-amber-400 rounded-lg hover:bg-amber-500/10 hover:border-amber-500 transition-all font-semibold text-left"
              >
                1st Sem - Pool A
                <span className="block text-xs mt-1 font-normal text-gray-500">
                  Chemistry • Manufacturing • Maths • Physics • Electrical
                </span>
              </button>
              <button
                type="button"
              ...
              >
                1st Sem - Pool B
                <span className="block text-xs mt-1 font-normal text-gray-500">
                  Environmental • Manufacturing • Maths • Physics • C •
                  Communication
                </span>
              </button>
              <button
          ...
          <div className="p-6">
            ...
            <div className="mb-6 p-4 bg-black border border-zinc-800 rounded-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-zinc-900 border border-zinc-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-gray-600"
                />
                <button
                  type="button"
                  onClick={applyDefaultMarks}
                  className="px-6 py-3 bg-zinc-800 border border-zinc-700 text-gray-300 rounded-lg hover:bg-zinc-700 hover:border-amber-500/50 transition-all font-semibold whitespace-nowrap"
                >
                  Apply to All
                </button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="hidden md:grid md:grid-cols-7 gap-4 pb-4 border-b border-zinc-800">
                <div className="col-span-2 font-semibold text-gray-400 uppercase text-xs tracking-wider">
                  Subject
                </div>
              ...
              <div className="space-y-3">
                {formData.map((entry, index) => (
                  <div
                    key={index}
                    className="bg-black border border-zinc-800 p-4 rounded-lg hover:border-amber-500/30 transition-all relative"
                  >
                    {/* Mobile Layout */}
                    <div className="md:hidden space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-zinc-900 border border-zinc-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                          required
                        />
                      </div>
                    ...
                    <div className="hidden md:grid md:grid-cols-7 gap-4 items-center">
                      <input
                        ...
                        placeholder="Subject name"
                        className="col-span-2 px-4 py-3 bg-zinc-900 border border-zinc-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-gray-600"
                        required
                      />
                      ...
                      <input
                        ...
                        className="px-4 py-3 bg-zinc-900 border border-zinc-700 text-white rounded-lg text-center focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                        required
                      />

                      <div
                        className={`px-4 py-3 text-center rounded-lg font-bold ${
                          show && entry.newMarks1 > 60
                            ? "bg-red-500/20 text-red-400 border border-red-500/30"
                            : show
                            ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/30"
...
<div className="flex flex-col sm:flex-row gap-3 pt-4">
  ...
  <button
    type="button"
    onClick={addSubject}
    className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-zinc-800 border border-zinc-700 text-gray-300 rounded-lg hover:bg-zinc-700 hover:border-amber-500/50 transition-all font-semibold"
  >
    <Plus size={20} />
    Add Subject
  </button>
  ...
  <button
    ...
    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-all font-semibold shadow-lg shadow-amber-500/20"
  >
    <Calculator size={20} />
    Calculate 
  </button>
  ...
  <button
    type="button"
    onClick={saveToLocal}
    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-zinc-800 border border-zinc-700 text-gray-300 rounded-lg hover:bg-zinc-700 hover:border-amber-500/50 transition-all font-semibold"
  >
    Save Progress
  </button>
        ...
        <div className="mt-8 p-6 bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="flex flex-col items-center md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-white opacity-50 font-bold text-lg">
                Meet the Developer{" "}
              </p>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center gap-2 px-5 py-3 bg-zinc-800 border border-zinc-700 text-gray-300 rounded-lg hover:bg-zinc-700 hover:border-amber-500/50 transition-all font-semibold"
              >
                <Github size={20} />
